...
# instead the median becomes the average of the two numbers 
# found in the middle. For this mission, you are given a non-empty 
# array of natural numbers (X). With it, you must separate the 
# upper half of the numbers from the lower half and find the median.
...
def checkio(data):
    ...
    if len(data) % 2 == 1:
        ...
        return (data[index-1] + data[index])/2.0
